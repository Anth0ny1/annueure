...
class SocietyTableSeeder extends Seeder
{
    ...
    public function run()
  {
      ...
      $society[] = array(
        'user_id'        => 1,
        'name_society'       => 'Maugy Entreprise générale du bâtiment Eure',
        'gerant'       => 'M. Maugy',
        'adress'    => '2 Rue d\'Elbeuf',
        'city'        => 'Iville',
        'zip_code'        => '27110',
        'phone'        => '0232351510',
        'site_web'        => 'http://www.maugy.fr/',
      ...
      $society[] = array(
        'user_id'        => 2,
        'name_society'       => 'Cohin Construction',
        'gerant'       => 'M. Cohin',
        'adress'    => 'N°6, rue de la Muette',
        'city'        => 'Écardenville-sur-Eure',
        'zip_code'        => '27490',
        'phone'        => '0232242727',
        'site_web'        => 'https://cohin-construction.com/',
